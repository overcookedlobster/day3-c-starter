 ...
 *
 * Implement the student struct and update_grade function as described in
 * tutorial Step 4.
 *
 * TODO:
 * 1. Define the Student struct with char name[20]; int grade;
 * 2. Implement update_grade(Student *s, int new_grade) to change the grade
 * using ->
 * 3. In main:
...
void update_grade(Student *s, int new_grade) {
  ...
  // Hint: Use the arrow operator -> to access and modify the grade member of
  // the struct.
...
int main() {
  ...
  // } else {
  //     printf("Implementation incomplete or incorrect.\n");
  // }
